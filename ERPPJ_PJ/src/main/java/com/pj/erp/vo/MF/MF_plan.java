...
public class MF_plan {
	...
	private Number ef_cost;			//예상 생산 원가
	private Number ef_amount;		//목표 생산 수량
	...
	public Number getEf_cost() {
		return ef_cost;
	}

	public void setEf_cost(Number ef_cost) {
		this.ef_cost = ef_cost;
	}

	public Number getEf_amount() {
		return ef_amount;
	}

	public void setEf_amount(Number ef_amount) {
