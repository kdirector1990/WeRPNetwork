...
public class MateralServiceImpl {
	...
	private static final Web3j web3j = Web3j.build(new HttpService("https://mainnet.infura.io/v3/d11459c1c17049628f462a1492c7df36"));
    ...
    @SuppressWarnings("deprecation")
	public void budgetAdd(HttpServletRequest req) throws Exception {
    	String department_code = req.getParameter("department_code");
    	
    	BlockChainVO vo = dao.getGroupCode(department_code);
	...
	public void payMaterial(HttpServletRequest req) throws Exception {
    	...
    	//계약서 작성.
    	contractAddress2 = Materal.deploy(web3j, hostCredentials, gasPrice, gasLimit).send().getContractAddress();
    	...
    	Materal dept = Materal.load(contractAddress2, web3j, dept_AccountNumber, gasPrice, gasLimit);
