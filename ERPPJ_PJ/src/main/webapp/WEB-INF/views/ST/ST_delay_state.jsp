									...
									<div class="table-responsive">
										<table id="datatable"
											...
											<tr>
												...
												<td>납품처 <input type="text" class="">&nbsp;<a
													href="#"><i class="dripicons-zoom-in"></i></a><input
													type="text" class=""></td>
											</tr>
											...
											<tr>
												...
												<td><input type="text" class="">&nbsp;<a
													href="#"><i class="dripicons-zoom-in"></i></a><input
													type="text" class=""></td>
												<td>프로젝트 <input type="text" class="">&nbsp;<a
													href="#"><i class="dripicons-zoom-in"></i></a><input
													type="text" class=""></td>
											</tr>
											...
											<tr>
												...
												<td><input type="text" class="">&nbsp;<a
													href="#"></a><button type="button" class="btn btn-primary waves-effect waves-light" id = "search">검색</button></td>
