                                                ...
                                                <div class="form-group row">
                                                 <label class="col-md-2 col-form-label">품번</label>
                                                     ...
                                                     <div class="form-group row">
                                                        ...
                                                        <div class="col-md-10">
                                                           <input type="text" name="ef_amount" class="form-control" value="" style="width: 350px;">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-md-2 col-form-label">기간 시작</label>
                                                             <div class="col-md-10">
                                                                 <input type="date" name= "s_plan_start" placeholder="mm/dd/yyyy" style="size: 100px;">
                                                        ...
                                                        <label class="col-md-2 col-form-label">기간 종료</label>
                                                             <div class="col-md-10">
                                                                 <input type="date" name= "s_plan_end" placeholder="mm/dd/yyyy" style="size: 100px;">
                                                                 <i class="mdi mdi-calendar"></i>
                                                             </div>
                                     				  </div>
                                            ...
                                            <div class="col-xl-6">
                                                    ...
                                                    <div class="form-group row">
                                                       ...
                                                       <div class="form-group row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input type="text" name="sp_unit" class="form-control" placeholder="" style="width: 350px;">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-10">
                                                           <input type="text" name="ef_price" class="form-control" value="" style="width: 350px;">
                                                        </div>
                                                    </div>
