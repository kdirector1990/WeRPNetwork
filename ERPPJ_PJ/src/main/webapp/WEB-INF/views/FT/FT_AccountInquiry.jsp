                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-body table-responsive">
                                        ...
                                        <c:forEach var="mabis" begin="0" end="5" step="1">
                                        	<button type="button" class="btn btn-outline-primary waves-effect waves-light">${mabis}</button>
                                        </c:forEach>
    									<br>
    									</div>
