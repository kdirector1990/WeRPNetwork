	                            		...
	                            		<tbody style="overflow:auto;">
	                                  		...
	                                  		<c:if test="${users != null}">
	                                   		<c:forEach var = "sub" items="${users}">
	                                    		<tr>
	                                    			<td id = "code${count}" onclick="focuse(${count});" style = "width: 80px;" ondblclick="setvalue();">${sub.username}</td>
	                                    			<td id = "name${count}" onclick="focuse(${count});" ondblclick="setvalue();" style = "width: calc( 200px - 16px );">${sub.e_name}</td>
