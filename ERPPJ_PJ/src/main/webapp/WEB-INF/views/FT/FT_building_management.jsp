                ...
                if(window.event.which == 37) {
					...
					return false;
	       			...
	       			$(".chit-table-bordered-primary tbody").append('<tr>' +
	       					'<td align = "center"><input type="checkbox" id = "first' + count + '" onfocus = "focuse(' + count + ');" name = "checkbox' + count + '" class="form-control" data-toggle="input-mask" style = "width: 20px; border:0px;" onkeydown = "enter(this.tagName, this.name);"></td>' +
	                        '<td><input type="text" onfocus = "focuse(' + count + ');" name = "code' + count + '" class="form-control" data-toggle="input-mask" style = "width: 100%; border:0px;" onkeydown = "enter(this.tagName, this.name);"></td>' +
	                        '<td><input type="text" id = "enter' + count + '" onfocus = "focuse(' + count + ');" name = "AccName' + count + '" class="form-control" data-toggle="input-mask" style = "width: 100%; border:0px;" onkeydown = "enterinsert(' + count + ');"></td>' +
	                       '</tr>');
	                    count = count + 1;
	                                ...
	                                <div id="collapseOne" class="collapse show" data-parent="#accordion-test">
	                                    <div class="card-body">
                                            ...
                                            <table class="table m-0 chit-table-colored-bordered chit-table-bordered-primary table-bordered">
		                                        ...
		                                        <tbody>
		                                            <tr>
		                                                <td align = "center"><input type="checkbox" id = "first0" onfocus = "focuse(0);" name = "checkbox0" class="form-control" data-toggle="input-mask" style = "width: 20px; border:0px;" value = "30" readonly onkeydown = "enter(this.tagName, this.name);"></td>
		                                                <td><input type="text" onfocus = "focuse(0);" name = "buildingCode0" class="form-control" data-toggle="input-mask" style = "width: 100%; border:0px;" onkeydown = "enter(this.tagName, this.name);"></td>
		                                                <td><input type="text" id = "enter0" onfocus = "focuse(0);" name = "buildingName0" class="form-control" data-toggle="input-mask" style = "width: 100%; border:0px;" onkeydown = "enterinsert(0);"></td>
		                                            </tr>
		                                        </tbody>
                                            </table>
                                        </div>
										...
										<div class="col-sm-12">
											<div class="card-body table-responsive">
												...
												<div class="form-group row">
													<div class="col-md-5">
														<div class="form-group row">
															<label class="col-lg-4 col-form-label" for="simpleinput">건물명<span class="text-danger">*</span></label>
															<div class="col-lg-8">
														...
														<div class="form-group row">	
															<label class="col-lg-4 col-form-label"
																for="simpleinput">건물주소<span class="text-danger">*</span></label>
															<div class="col-lg-8">
																<input type="text" class="form-control" name="e_name" placeholder = "한글이름" style = "width:20%; display: inline;">
														...
														<div class="form-group row">	
															<label class="col-lg-4 col-form-label"
																for="simpleinput">구입일<span class="text-danger">*</span></label>
															<div class="col-lg-8">
																<input type="text" class="form-control" name="e_name" placeholder = "한글이름">
															</div>
														</div>
													...
													<label class="col-md-1 col-form-label" for="simpleinput">&nbsp;</label>
														<div class="col-md-5">
															<div class="form-group row">
																<label class="col-lg-4 col-form-label" for="simpleinput">계정<span class="text-danger">*</span></label>
																<div class="col-lg-8">
																	<input type="text" class="form-control" name="e_name" placeholder = "한글이름" style = "width:20%; display: inline;">
																	<button type="button" class="btn btn-icon waves-effect waves-light btn-primary"> <i class="fas fa-search"></i> </button>
																	<input type="text" class="form-control" name="e_name" placeholder = "한글이름" style = "display:inline; width: 65%;">
																</div>
															</div>
														
															<div class="form-group row">	
																<label class="col-lg-4 col-form-label"
																	for="simpleinput">사용부서<span class="text-danger">*</span></label>
																<div class="col-lg-8">
																	<input type="text" class="form-control" name="e_name" placeholder = "한글이름" style = "width:20%; display: inline;">
																	<button type="button" class="btn btn-icon waves-effect waves-light btn-primary"> <i class="fas fa-search"></i> </button>
																	<input type="text" class="form-control" name="e_name" placeholder = "한글이름" style = "display:inline; width: 65%;">
															...
															<div class="form-group row">	
																<label class="col-lg-4 col-form-label"
																	for="simpleinput">구입가<span class="text-danger">*</span></label>
																<div class="col-lg-8">
																	<input type="text" class="form-control" name="e_name" placeholder = "한글이름">
																</div>
															</div>
