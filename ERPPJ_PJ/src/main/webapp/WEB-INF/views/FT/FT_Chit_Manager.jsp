                    	   ...
                    	   if(data != null){
							for(var i = 0; i < data.length; i++){
								...
								$(".chitsub-table-bordered-primary tbody").append('<tr>' +
                                    '<td><input type="text" onfocus = "subfocuse(' + i + ');" name = "key' + i + '" class="form-control" data-toggle="input-mask" style = "width: 100%; border:0px;" value = "' + data[i].journal_code + '" readonly onkeydown = "enter(this.tagName, this.name);" ondblclick = "javascript: chitManager.action = \'FT_insertChit?keynum=' + parseInt(i) + '\' chitManager.submit();"></td>' +
                                    '<td><input type="text" onfocus = "subfocuse(' + i + ');" id = "first' + i + '" name = "RLstate' + i + '" class="form-control" data-toggle="input-mask" style = "width: 100%; border:0px;" value = "' + RLtype + '" readonly onkeydown = "enter(this.tagName, this.name);" ondblclick = "javascript: chitManager.action = \'FT_insertChit?keynum=' + parseInt(i) + '\' chitManager.submit();"></td>' +
                                    '<td><input type="text" onfocus = "subfocuse(' + i + ');" name = "SubjectCode' + i + '" class="form-control" data-toggle="input-mask" style = "width: 100%; border:0px;" value = "' + data[i].detail_ac_code + '" readonly onkeydown = "enter(this.tagName, this.name);" ondblclick = "javascript: chitManager.action = \'FT_insertChit?keynum=' + parseInt(i) + '\' chitManager.submit();"></td>' +
                                    '<td><input type="text" onfocus = "subfocuse(' + i + ');" name = "SubjectName' + i + '" class="form-control" data-toggle="input-mask" style = "width: 100%; border:0px;" value = "' + data[i].account_name + '" readonly onkeydown = "enter(this.tagName, this.name);" ondblclick = "javascript: chitManager.action = \'FT_insertChit?keynum=' + parseInt(i) + '\' chitManager.submit();"></td>' +
                                    '<td><input type="text" onfocus = "subfocuse(' + i + ');" name = "AccCode' + i + '" class="form-control" data-toggle="input-mask" style = "width: 100%; border:0px;" value = "' + data[i].customer_code + '" readonly onkeydown = "enter(this.tagName, this.name);" ondblclick = "javascript: chitManager.action = \'FT_insertChit?keynum=' + parseInt(i) + '\' chitManager.submit();"></td>' +
                                    '<td><input type="text" onfocus = "subfocuse(' + i + ');" name = "AccName' + i + '" class="form-control" data-toggle="input-mask" style = "width: 100%; border:0px;" value = "' + data[i].customer_name + '" readonly onkeydown = "enter(this.tagName, this.name);" ondblclick = "javascript: chitManager.action = \'FT_insertChit?keynum=' + parseInt(i) + '\' chitManager.submit();"></td>' +
                                    '<td><input type="text" onfocus = "subfocuse(' + i + ');" name = "price' + i + '" class="form-control" data-toggle="input-mask" style = "width: 100%; border:0px;" value = "' + price + '" readonly onkeydown = "enter(this.tagName, this.name);" ondblclick = "javascript: chitManager.action = \'FT_insertChit?keynum=' + parseInt(i) + '\' chitManager.submit();"></td>' +
                                    '<td><input type="text" onfocus = "subfocuse(' + i + ');" name = "count' + i + '" class="form-control" data-toggle="input-mask" style = "width: 100%; border:0px;" value = "' + count + '" readonly onkeydown = "enter(this.tagName, this.name);" ondblclick = "javascript: chitManager.action = \'FT_insertChit?keynum=' + parseInt(i) + '\' chitManager.submit();"></td>' +
                                    '<td><input type="text" onfocus = "subfocuse(' + i + ');" name = "text' + i + '" class="form-control" data-toggle="input-mask" style = "width: 100%; border:0px;" value = "' + data[i].journal_abstract + '" readonly onkeydown = "enter(this.tagName, this.name);" ondblclick = "javascript: chitManager.action = \'FT_insertChit?keynum=' + parseInt(i) + '\' chitManager.submit();"></td>' +
                                    '<td><input type = "text" name = "writer' + i + '" value = "' + data[i].last_modi_user + '" onfocus = "subfocuse(' + i + ');" class="form-control" data-toggle="input-mask" style = "width: 100%; border:0px;" readonly onkeydown = "enter(this.tagName, this.name);" ondblclick = "javascript: chitManager.action = \'FT_insertChit?keynum=' + parseInt(i) + '\' chitManager.submit();"></td>' +
                                    '<td><select class="form-control" id = "enter' + i + '" onfocus = "subfocuse(' + i + ');" name = "type' + i + '" style = "width: 100%; -webkit-appearance: none; border:0px;" readonly onkeydown = "enter(this.tagName, this.name);" ondblclick = "javascript: chitManager.action = \'FT_insertChit?keynum=' + parseInt(i) + '\' chitManager.submit();">' +
