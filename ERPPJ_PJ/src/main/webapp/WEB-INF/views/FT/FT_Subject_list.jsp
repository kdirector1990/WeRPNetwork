...
<head>
    ...
    <script type="text/javascript">
	    ...
	    function setvalue(val){
			$("input[name=subjectcode${keyname}]", opener.document).val($("#code" + val).html());
    		$("input[name=subjectname${keyname}]", opener.document).val($("#name" + val).html());
    		
    		var keyname = $("#name" + val).html();	
							...
							<div class="card">
								<div class="card-body" style = "padding-bottom:0px;">
									<div style = "text-align: center;">
										<label>Search : <input type="search" id = "searchid" class="form-control form-control-sm" aria-controls="datatable" style = "display:inline-block; width:150px;"></label>
									</div>
									<div align="right">
	                            		...
	                            		<tbody style="overflow:auto;">
	                                  		...
	                                  		<c:if test="${subject != null}">
	                                   		<c:forEach var = "sub" items="${subject}">
	                                    		<tr>
	                                    			<td id = "code${count}" style = "width: 80px;" ondblclick="setvalue(${count})">${sub.detail_ac_code}</td>
	                                    			<td id = "name${count}" ondblclick="setvalue(${count})" style = "width: calc( 200px - 16px );">${sub.account_name}</td>
