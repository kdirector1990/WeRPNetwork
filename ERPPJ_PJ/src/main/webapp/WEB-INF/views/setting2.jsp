...
<meta http-equiv="X-UA-Compatible" content="IE=edge" />
        ...
        <script src="assets/libs/datatables/dataTables.colVis.js"></script>
        ...
        <script src="assets/js/pages/mapael-maps.init.js"></script>
        ...
        <script src="assets/libs/raphael/raphael.min.js"></script>
        <script src="assets/libs/jquery-mapael/jquery.mapael.min.js"></script>
        <script src="assets/libs/jquery-mapael/world_countries.min.js"></script>
        <script src="assets/libs/jquery-mapael/usa_states.min.js"></script>
        ...
        <!-- Tooltipster js -->
        <script src="assets/libs/tooltipster/tooltipster.bundle.min.js"></script>
        <script src="assets/js/pages/tooltipster.init.js"></script>
