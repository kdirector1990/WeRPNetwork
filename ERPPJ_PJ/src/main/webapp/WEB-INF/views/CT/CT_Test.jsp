               ...
               <div id="result2">
	               <c:if test="${selectCnt == 1 }">
							<table class="table mb-0">
								...
								<tr>
									<td>${voC.ceq_code}
			                		<td><input type="text" name="ceq_name" value="${voC.ceq_name }" class="form-control" data-toggle="input-mask" style = "width: 100%; border:0px;" autofocus>
			                		<td><select name="ceq_type" class="form-control" data-toggle="input-mask" style = "width: 100%; border:0px;">
			                		...
			                		<td><input type="date" name="ceq_acquire_date" value="${voC.ceq_acquire_date }" class="form-control" data-toggle="input-mask" style = "width: 100%; border:0px;">
			                		<td><select name="ceq_department_code" class="form-control" data-toggle="input-mask" style = "width: 100%; border:0px;">
			                		...
			                		<td><input type="text" name="ceq_location" value="${voC.ceq_location }" class="form-control" data-toggle="input-mask" style = "width: 100%; border:0px;"> 
			                		<td><input type="text" name="ceq_prime_cost" value="${voC.ceq_prime_cost}" class="form-control" data-toggle="input-mask" style = "width: 100%; border:0px;" onkeyup="removeChar(event); inputNumberFormat(this);">
			                		<td><input type="text" name="ceq_durable" value="${voC.ceq_durable }" class="form-control" data-toggle="input-mask" style = "width: 100%; border:0px;" onkeyup="removeChar(event); inputNumberFormat(this);">
