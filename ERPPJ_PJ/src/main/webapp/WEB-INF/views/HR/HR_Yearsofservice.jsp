			...
			$.ajax({
				...
				success : function(list){
					...
					for(var i = 0 ; i < list.length; i++){
						...
						var day = pa.getDate(); 
						var start_dates = year + "/" + month +"/"+day;
					...
					$('#result').append('<tr>'+
							...
							'<td>'+ start_dates +'</td>'+
							'<td>'+ service_years + '년' + service_months +'개월'+'</td>'+
							'<td>'+ e_codes +'</td>'+
                 		'</tr>');
						...
						<div class="card">
							...
							<table class = "col-12" id="datatable"
								...
								<tr class="form-group row">
									<th class="col-md-1 col-form-label" style = "text-align : right;">부서</th>
									<td class="col-md-1 input-group">
											<input type="text" class="form-control" name="department_name" id = "department_name" placeholder = "부서명">
											</td>
									<th class="col-md-1 col-form-label"style = "text-align : right;">사원검색</th>
										<td class="col-md-1 input-group">
											<input type="text" class="form-control" name="e_name" id = "e_name" placeholder = "한글이름">
											</td>
										<th class="col-md-1 col-form-label"style = "text-align : right;">퇴사자</th>
										<td class="col-md-1 input-group"><select class="form-control select2" name="e_state_code" id = "e_state_code" >
												<option value="1">제외</option>
												<option value="0">포함</option>																						
											</select></td>
										<th class="col-md-1 col-form-label"style = "text-align : right;">기준일</th>
										<td class="col-md-2 input-group"><input type="text" class="form-control" name = "day" id = "day" data-provide="datepicker" data-date-autoclose="true"></td>
