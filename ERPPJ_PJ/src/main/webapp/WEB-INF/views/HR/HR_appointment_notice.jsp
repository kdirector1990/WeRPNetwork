                                    ...
                                    <div class="card-body table-responsive">                                     
    									...
    									<table id="datatable" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            <tr>
                                                <td>사업장</td>
                                                <td>
                                                <input type="text" class="" value="1000" readonly>&nbsp;<a href="#"><i class="dripicons-zoom-in"></i></a>
                                                	<input type="text" class="" value="인사1급 회사본사" readonly>
                                                </td>                                                
                                            ...
                                            <tr>
                                            	...
                                            	<td>퇴사자</td>
                                            	<td>
	                                            	<select class="input" name="" onchange="">
			                                            <option></option>
