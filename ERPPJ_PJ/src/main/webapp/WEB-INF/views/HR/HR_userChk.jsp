...
<body>
<form action="userChk" method="post" name="confirmform" onsubmit="return userNameChk();">
	...
	<c:if test="${selectCnt == 1}">
		<table>
			<tr>
				<th colspan="2">
					<span>${username}</span>는 이미 등록되었습니다.
				</th>
			</tr>
	...
	<c:if test="${selectCnt != 1}">
		<table>
			...
			<tr>
				<th>
					<button class="btn btn-primary waves-effect waves-light mr-1" type="button" value="확인" onclick="setUsername('${username}');">
                                            확인
                    </button>
