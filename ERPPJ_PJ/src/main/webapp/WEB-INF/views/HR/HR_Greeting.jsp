								...
								<div class="col-xl-6">
									<form action="HR_APinput"class="form-horizontal" method="post">
										<div class="form-group row">
											...
											<div class="col-md-10">
												<input type="text" id="simpleinput" class="form-control" name="ap_name" >
											</div>
										</div>
										<div class="form-group row">
											<label class="col-md-2 col-form-label" for="simpleinput">공고내용</label>
											<div class="col-md-10">
												<input type="text" id="simpleinput" class="form-control" name="ap_content" >
											</div>
										</div>																				
										<div class="form-group row">
										...
										<div class="form-group row">
											<label class="col-md-2 col-form-label" for="example-textarea">공고상태</label>
											<div class="col-md-10">
												<select class="form-control select2" name="ap_status" onchange="">
